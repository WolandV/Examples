...
define("NO_SPREAD_COOKIE", true);

require_once(dirname(__FILE__)."/../../main/include/prolog_before.php");
require_once(dirname(__FILE__)."/../../main/classes/general/controller_member.php");
...
else
{
	...
	{
		/* Company */
		case "CIClientSiteCompany::Add":
			$oResponse->arParameters = CIClientSiteCompanyFromController::Add($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
			
		case "CIClientSiteCompany::Delete":
			$oResponse->arParameters = CIClientSiteCompanyFromController::Delete($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
		
		
		/* Interest Area */
		case "CIClientSiteInterestAreaFromController::Add":
			$oResponse->arParameters = CIClientSiteInterestAreaFromController::Add($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
			
		case "CIClientSiteInterestAreaFromController::Delete":
			$oResponse->arParameters = CIClientSiteInterestAreaFromController::Delete($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
		
		
		/* User */
		case "CIClientSiteUser::Add":
			$oResponse->arParameters = CIClientSiteUserFromController::Add($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
		case "CIClientSiteUser::AddWithGroups":
			$oResponse->arParameters = CIClientSiteUserFromController::AddWithGroups($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
		case "CIClientSiteUser::Delete":
			$oResponse->arParameters = CIClientSiteUserFromController::Delete($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
		case "CIClientSiteUser::GetGroupsList":
			$oResponse->arParameters = CIClientSiteUserFromController::GetGroupsList($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
		case "CIClientSiteUser::GetUserGroups":
			$oResponse->arParameters = CIClientSiteUserFromController::GetUserGroups($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
		case "CIClientSiteUser::SetUserGroups":
			$oResponse->arParameters = CIClientSiteUserFromController::SetUserGroups($oRequest->arParameters);  
			$oResponse->status = "200 OK"; 
			break;
